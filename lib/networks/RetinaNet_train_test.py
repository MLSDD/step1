    ...
    def setup(self):
        ...
        with tf.variable_scope('Top-Down'):
            ...
            (self.feed('res4f_relu') #C4
                 .conv(1,1,256,1,1,biased=True,relu=False,name='P4')) #P4
             
            (self.feed('res3d_relu')
                 .conv(1,1,256,1,1,biased=True,relu=False,name='C3_lateral')) #C3
            ...
            (self.feed('C4_topdown',
                       'C3_lateral')
                 .add(name='P3_pre')
                 .conv(3,3,256,1,1,biased=True,relu=False,name='P3')) #P3
            
            (self.feed('bn2c_branch2c')
        ...
        with tf.variable_scope('clsSubNet') as scope:
            ...
            (self.feed('P2')
                 .conv(3,3,256,1,1,name='cls_conv_1/P2',reuse=False)
                 .conv(3,3,256,1,1,name='cls_conv_2/P2',reuse=False)
                 .conv(3,3,num_anchor*n_classes,1,1,cls_final=True,bias_init=-np.log((1-pi)/pi),relu=False,name='cls_score/P2',reuse=False)
                 #.conv(3,3,num_anchor*n_classes,1,1,relu=False,name='cls_score/P3',reuse=True)
                 .reshape_layer([-1, n_classes],name='cls_score_reshape/P2')
                 .softmax(name='cls_prob/P2'))

            (self.feed('P3')
                 .conv(3,3,256,1,1,name='cls_conv_1/P3',reuse=False)
                 .conv(3,3,256,1,1,name='cls_conv_2/P3',reuse=False)
                 .conv(3,3,num_anchor*n_classes,1,1,cls_final=True,bias_init=-np.log((1-pi)/pi),relu=False,name='cls_score/P3',reuse=False)
                 #.conv(3,3,num_anchor*n_classes,1,1,relu=False,name='cls_score/P3',reuse=True)
            ...
            (self.feed('P4')
                 .conv(3,3,256,1,1,name='cls_conv_1/P4',reuse=False)
                 .conv(3,3,256,1,1,name='cls_conv_2/P4',reuse=False)
                 .conv(3,3,num_anchor*n_classes,1,1,cls_final=True,bias_init=-np.log((1-pi)/pi),relu=False,name='cls_score/P4',reuse=False)
            ...
            (self.feed('cls_score_reshape/P2',
                       'cls_score_reshape/P3',
        ...
        with tf.variable_scope('boxSubNet') as scope:
            (self.feed('P2')
                 .conv(3,3,256,1,1,name='box_conv_1/P2',reuse=True)
                 .conv(3,3,256,1,1,name='box_conv_2/P2',reuse=True)
                 .conv(3,3,num_anchor*4,1,1,relu=False,name='box_pred/P2',reuse=True)
                 .reshape_layer([-1, 4],name='box_pred_reshape/P2'))
            scope.reuse_variables()
            ...
            (self.feed('box_pred_reshape/P2',
                       'box_pred_reshape/P3',
                       'box_pred_reshape/P4')
                 .concat(0, name = 'box_pred_reshape_concat'))

            (self.feed('cls_score/P2',
                       'cls_score/P3',
                       'cls_score/P4',
                       'gt_boxes', 'im_info')
                 .anchor_target_layer(num_anchor_scale, _feat_stride, anchor_size, name = 'rpn-data'))
...
# ----------------------------------------------------------------------------------------------------------------------------
    ...
    def build_loss(self):
        ...
        cls_score = tf.reshape(tf.gather(cls_score, keep), [-1, 2]) # shape (N, n_classes)
